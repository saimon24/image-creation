...
export const items: ItemDefinition[] = [
  ...
  { id: "blueberry", name: "Blueberry", category: "crops", expectedPath: "crops/blueberry.webp", description: "Plump blue blueberries" },
  { id: "raspberry", name: "Raspberry", category: "crops", expectedPath: "crops/raspberry.webp", description: "Red raspberry" },
  { id: "blackberry", name: "Blackberry", category: "crops", expectedPath: "crops/blackberry.webp", description: "Dark blackberry" },
  { id: "cranberry", name: "Cranberry", category: "crops", expectedPath: "crops/cranberry.webp", description: "Red cranberries" },
  { id: "pineapple", name: "Pineapple", category: "crops", expectedPath: "crops/pineapple.webp", description: "Tropical pineapple" },
  { id: "bamboo_fiber", name: "Bamboo Fiber", category: "crops", expectedPath: "crops/bamboo_fiber.webp", description: "Processed bamboo fibers" },
  { id: "sunflower_seed", name: "Sunflower Seed", category: "crops", expectedPath: "crops/sunflower_seed.webp", description: "Sunflower seeds" },
  { id: "tea_leaf", name: "Tea Leaf", category: "crops", expectedPath: "crops/tea_leaf.webp", description: "Single tea leaf" },
  { id: "vanilla_orchid", name: "Vanilla Orchid", category: "crops", expectedPath: "crops/vanilla_orchid.webp", description: "Vanilla orchid flower" },
  { id: "saffron_blossom", name: "Saffron Blossom", category: "crops", expectedPath: "crops/saffron_blossom.webp", description: "Purple saffron crocus flower" },
  { id: "cacao_pod", name: "Cacao Pod", category: "crops", expectedPath: "crops/cacao_pod.webp", description: "Large cacao pod" },
